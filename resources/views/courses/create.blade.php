            ...
            <div class="row border rounded m-2">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input value="{{ old('hours') }}" type="text" class="form-control" name="hours" id="hours"
                            aria-describedby="helpId" placeholder="Hours">
                    </div>
                </div>
                <div class="col-6">
                    ...
                    <select required name="vendor_id" class="form-select" aria-label="Default select">
                        <option value="{{ old('vendor_id') }}">Open this select menu</option>
                ...
                <div class="col-6">
                    ...
                    <select required name="category_id" class="form-select" aria-label="Default select">
                        <option value="{{ old('category_id') }}">Open this select menu</option>
