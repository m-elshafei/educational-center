...
@section('content')
    <div class="rounded bg-white p-3 m-3">
        ...
        <form method="POST" action="{{ route('companies.update',$employees->id) }}">
            @method('patch')
            @csrf
            ...
            <div class="row border rounded m-2">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input value="{{ $employees->name }}" type="text" class="form-control" name="name" id="name"
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input value="{{ $employees->owner }}" type="text" class="form-control" name="owner"
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input value="{{ $employees->tax_numebr }}" type="text" class="form-control" name="tax_numebr"
