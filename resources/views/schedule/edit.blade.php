            ...
            <div class="row border rounded m-2">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input value="{{ $schedule->start_date }}" type="date" class="form-control" name="start_date"
                ...
                <div class="col-md-6">
                    ...
                    <select required name="instructor_id" class="form-select" aria-label="Default select">
                        <option value="{{ $schedule->instructor->user->name }}">
                            {{ $schedule->instructor->user->name }}</option>
